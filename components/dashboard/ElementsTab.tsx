    ...
    <div className="space-y-12 animate-in fade-in duration-500">
                ...
                <div className="space-y-8 pt-2">
                        ...
                        <div>
                            ...
                            <div className="relative w-full h-2 rounded-lg" style={{ backgroundColor: theme.colors.text + '20' }}>
                                <div className="absolute left-[20%] right-[30%] top-0 bottom-0 rounded-lg" style={{ backgroundColor: theme.colors.primary }}></div>
                                <div className="absolute left-[20%] top-1/2 -translate-y-1/2 w-4 h-4 bg-white border shadow rounded-full cursor-grab"></div>
                                <div className="absolute right-[30%] top-1/2 -translate-y-1/2 w-4 h-4 bg-white border shadow rounded-full cursor-grab"></div>
                            </div>
                        </div>
                </div>
            </div>
        ...
        <section>
            ...
            <div className="flex flex-wrap gap-12">
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3 cursor-pointer" onClick={() => setToggleState(!toggleState)}>
                        <div 
                        ...
                        <span className="text-sm font-medium" style={{ color: theme.colors.text }}>Notifications</span>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="w-5 h-5 rounded border flex items-center justify-center text-white" style={{ backgroundColor: theme.colors.primary, borderColor: theme.colors.primary, borderRadius: theme.borderRadius.sm }}>
                            <Icons.Check/>
                        </div>
                        <span className="text-sm" style={{ color: theme.colors.text }}>Selected Option</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-5 h-5 rounded border" style={{ backgroundColor: theme.colors.surface, borderColor: theme.colors.text + '30', borderRadius: theme.borderRadius.sm }}></div>
                        <span className="text-sm" style={{ color: theme.colors.text }}>Unselected Option</span>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="w-5 h-5 rounded-full border-4" style={{ borderColor: theme.colors.primary, backgroundColor: theme.colors.surface }}></div>
                        <span className="text-sm" style={{ color: theme.colors.text }}>Radio Active</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-5 h-5 rounded-full border" style={{ borderColor: theme.colors.text + '30', backgroundColor: theme.colors.surface }}></div>
                        <span className="text-sm" style={{ color: theme.colors.text }}>Radio Inactive</span>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section>
            ...
            <div className="space-y-8">
                {/* Chips */}
                <div>
                    <h4 style={subHeadingStyle}>Tags / Chips</h4>
                    <div className="flex flex-wrap gap-2">
                        <span className="px-3 py-1 rounded-full text-sm border flex items-center gap-2" style={{ borderColor: theme.colors.text + '30', backgroundColor: theme.colors.surface, color: theme.colors.text }}>
                            <Icons.Tag size="sm"/> Simple Tag
                        </span>
                        <span className="px-3 py-1 rounded-full text-sm flex items-center gap-2 text-white" style={{ backgroundColor: theme.colors.primary }}>
                            Primary Tag <button className="hover:opacity-70"><Icons.Close size="sm"/></button>
                        </span>
                        <span className="px-3 py-1 rounded-full text-sm flex items-center gap-2" style={{ backgroundColor: theme.colors.primary + '20', color: theme.colors.primary }}>
                            <div className="w-2 h-2 rounded-full bg-current"></div> Status
                        </span>
                    </div>
                </div>
                ...
                {/* Steppers */}
                <div>
                    <h4 style={subHeadingStyle}>Process Stepper</h4>
                    <div className="flex items-center max-w-xl relative">
                        ...
                        <div className="absolute top-1/2 left-0 w-1/2 h-0.5 -z-10" style={{ backgroundColor: theme.colors.primary }}></div>
                        ...
                        <div className="flex justify-between w-full">
                            {['Details', 'Payment', 'Review'].map((step, i) => {
                                ...
                                const current = i === 1;
                                return (
                                <div key={i} className="flex flex-col items-center gap-2 px-2" style={{ backgroundColor: theme.colors.background }}>
                                    <div 
                                        className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm transition-all`}
                                        style={{ 
                                            backgroundColor: active ? theme.colors.primary : theme.colors.background,
                                            border: `2px solid ${active ? theme.colors.primary : theme.colors.text + '20'}`,
                                            color: active ? '#fff' : theme.colors.textSecondary,
                                            boxShadow: current ? `0 0 0 4px ${theme.colors.primary}30` : 'none'
                                        }}
                                    >
                                        {active ? <Icons.Check size="sm"/> : i + 1}
                                    </div>
                                    <span className={`text-xs font-medium`} style={{ color: active ? theme.colors.text : theme.colors.textSecondary }}>{step}</span>
                                </div>
                                )
                            })}
                        </div>
            ...
            <div className="flex flex-wrap gap-12 items-center">
                <div className="flex -space-x-3">
                    {[1,2,3,4].map(i => (
                        ...
                        >
                            {i === 4 ? '+5' : `U${i}`}
                            <div className="absolute -top-8 left-1/2 -translate-x-1/2 text-[10px] py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none" style={{ backgroundColor: theme.colors.text, color: theme.colors.surface }}>
                                User {i}
                            </div>
                        </div>
                    ))}
                ...
                <div className="flex gap-4 items-center">
                    <div className="w-12 h-12 rounded-full relative" style={{ backgroundColor: theme.colors.text + '10' }}>
                        <span className="absolute bottom-0 right-0 w-3 h-3 border-2 rounded-full" style={{ backgroundColor: theme.colors.success, borderColor: theme.colors.surface }}></span>
                    </div>
                    <div className="w-12 h-12 rounded-full relative" style={{ backgroundColor: theme.colors.text + '10' }}>
        ...
        <section>
            ...
            <div className="space-y-8">
                ...
                {/* Pagination */}
                <div className="flex items-center gap-2">
                    <ThemedButton size="sm" variant="outline">Prev</ThemedButton>
                    {[1, 2, 3].map(p => (
                        <button 
                        key={p} 
                        className="w-8 h-8 rounded flex items-center justify-center text-sm transition-colors"
                        style={{ 
                            backgroundColor: p === 1 ? theme.colors.primary : 'transparent',
                            color: p === 1 ? '#fff' : theme.colors.text
                        }}
                        >
                            {p}
                        </button>
                    ...
                    <ThemedButton size="sm" variant="outline">Next</ThemedButton>
                </div>
        ...
        <section>
            ...
            <div className="space-y-8">
                ...
                <div>
                    ...
                    <div className="flex gap-4 items-start p-4 rounded-lg border" style={{borderColor: theme.colors.text+'20', backgroundColor: theme.colors.surface, borderRadius: theme.borderRadius.card}}>
                ...
                <div>
                     ...
                     <div className="grid grid-cols-4 gap-2 h-48">
                        <div className="col-span-2 row-span-2 rounded-lg flex items-center justify-center border" style={{backgroundColor: theme.colors.primary + '20', borderColor: theme.colors.primary + '40', borderRadius: theme.borderRadius.md}}>
                            <span className="text-xs font-bold opacity-50" style={{color: theme.colors.primary}}>Main Feature</span>
                        </div>
                        <div className="col-span-2 rounded-lg border" style={{backgroundColor: theme.colors.secondary + '10', borderColor: theme.colors.secondary + '30', borderRadius: theme.borderRadius.md}} />
                        <div className="col-span-1 rounded-lg border" style={{backgroundColor: theme.colors.accent + '20', borderColor: theme.colors.accent + '40', borderRadius: theme.borderRadius.md}} />
                        <div className="col-span-1 rounded-lg border" style={{backgroundColor: theme.colors.text + '05', borderColor: theme.colors.text + '10', borderRadius: theme.borderRadius.md}} />
                     </div>
                </div>
                ...
                {/* 3. Split Card */}
                 <div>
                     ...
                     <div className="flex flex-col sm:flex-row h-40 rounded-lg overflow-hidden border" style={{borderColor: theme.colors.text+'20', borderRadius: theme.borderRadius.card}}>
                        <div className="sm:w-1/3 flex items-center justify-center" style={{backgroundColor: theme.colors.text+'05'}}>
                           <Icons.Image style={{color: theme.colors.textSecondary, opacity: 0.5}} size="lg" />
                        </div>
                        <div className="flex-1 p-4 flex flex-col justify-center" style={{backgroundColor: theme.colors.surface}}>
                     ...
                     <div className="flex flex-col h-48 rounded-lg border overflow-hidden" style={{borderColor: theme.colors.text+'20', borderRadius: theme.borderRadius.card}}>
                        ...
                        <div className="flex flex-1">
                           <div className="w-12 border-r flex flex-col items-center py-3 gap-3" style={{borderColor: theme.colors.text+'10', backgroundColor: theme.colors.surface}}>
                               <div className="w-6 h-6 rounded flex items-center justify-center" style={{backgroundColor: theme.colors.text+'05'}}><Icons.Menu size="sm"/></div>
                               <div className="w-6 h-6 rounded flex items-center justify-center" style={{backgroundColor: theme.colors.text+'05'}}><Icons.User size="sm"/></div>
                           </div>
                 ...
                 <div>
                     ...
                     <div className="flex gap-3 overflow-x-auto pb-4 no-scrollbar">
                        {[1,2,3,4,5,6].map(i => (
                           <div 
                                key={i} 
                                className="w-24 h-24 shrink-0 rounded-lg flex flex-col items-center justify-center border hover:-translate-y-1 transition-transform" 
                                style={{
                ...
                <div className="max-w-2xl">
                    ...
                    <div className="p-6 border rounded-xl space-y-6" style={{borderColor: theme.colors.text+'20', backgroundColor: theme.colors.surface, borderRadius: theme.borderRadius.card}}>
                        ...
                        <div className="grid md:grid-cols-4 gap-4 items-center">
                            ...
                            <div className="md:col-span-3">
                                <select 
                                    className="w-full px-4 py-2 outline-none transition-all appearance-none bg-transparent border"
                                    style={{
                        ...
                        <div className="grid md:grid-cols-4 gap-4 items-start">
                             ...
                             <div className="md:col-span-3">
                                <textarea 
                                    className="w-full px-4 py-2 outline-none transition-all bg-transparent border min-h-[80px]"
                        ...
                        <div className="pl-4 space-y-1 border-l ml-2" style={{borderColor: theme.colors.text+'20'}}>
                            ...
                            <div className="pl-4 space-y-1 border-l ml-2" style={{borderColor: theme.colors.text+'20'}}>
                                {['Button.tsx', 'Card.tsx', 'Input.tsx'].map(f => (
                                    <div key={f} className="flex items-center gap-2 hover:bg-black/5 rounded px-1 cursor-pointer" style={{color: theme.colors.text}}>
        ...
        <section>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="relative h-64 rounded-xl overflow-hidden border flex items-center justify-center bg-black/5" style={{borderColor: theme.colors.text+'10'}}>
                    ...
                    {/* Modal Content */}
                    <div className="relative w-64 p-4 rounded-lg shadow-xl bg-white" style={{
                        backgroundColor: theme.colors.surface, 
                ...
                <div className="flex flex-col gap-3 justify-center p-4 border rounded-xl" style={{borderColor: theme.colors.text+'10', backgroundColor: theme.colors.background}}>
                    {[
                        {type: 'success', text: 'Changes saved successfully', icon: 'Check'},
                        {type: 'error', text: 'Connection failed', icon: 'Close'},
                        {type: 'info', text: 'Update available', icon: 'Help'},
                    ].map((t, i) => (
                        <div key={i} className="flex items-center gap-3 p-3 rounded shadow-sm border bg-white" style={{
                            backgroundColor: theme.colors.surface,
                            borderColor: theme.colors.text+'10',
                            borderRadius: theme.borderRadius.sm,
                            ...
                            <span className="text-sm font-medium" style={{color: theme.colors.text}}>{t.text}</span>
                        </div>
                    ))}
                </div>
            </div>
        ...
        <section>
            ...
            <div className="grid md:grid-cols-3 gap-6">
                ...
                <ThemedCard className="p-0 overflow-hidden">
                    ...
                    <div className="px-4 pb-4">
                        ...
                        <div className="flex gap-4 text-xs font-bold mb-4" style={{color: theme.colors.text}}>
                            ...
                            <div>12k <span className="font-normal opacity-60">Followers</span></div>
                        </div>
                        <ThemedButton size="sm" className="w-full">Follow</ThemedButton>
                    </div>
                </ThemedCard>
                ...
                {/* Sparkline Stat */}
                <ThemedCard className="flex flex-col justify-between">
                    <div>
                ...
                <div className="space-y-6">
                    <div className="flex gap-4">
                        ...
                        <div className="flex-1 space-y-2">
                            ...
                            <div className="flex gap-4 text-xs font-bold cursor-pointer" style={{color: theme.colors.textSecondary}}>
