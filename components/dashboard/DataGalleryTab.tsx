    ...
    <div className="animate-in fade-in duration-500 pb-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            ...
            <CardWrapper title="Tag Group">
             ...
             <CardWrapper title="Status: Active">
                <Centered>
             ...
             <CardWrapper title="Status: Offline">
                <Centered>
            ...
            <CardWrapper title="Avatar Group">
                 <Centered>
        ...
        <div style={sectionTitleStyle}>Complex Data Sets</div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="col-span-1 lg:col-span-2">
             ...
             <CardWrapper title="Activity Feed">
