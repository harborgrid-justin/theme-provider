    ...
    <div className="animate-in fade-in duration-500 pb-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-16">
            <GalleryItem title="Sidebar Item" centered>
                <div className="flex items-center gap-3 w-full px-4 py-2 rounded" style={{ backgroundColor: theme.colors.text + '05' }}>
            ...
            <GalleryItem title="Pagination: Number" centered>
                <div className="flex gap-1">
                    <div className="w-5 h-5 rounded flex items-center justify-center text-[10px] font-bold" style={{ backgroundColor: theme.colors.text + '10' }}>1</div>
                    <div className="w-5 h-5 rounded flex items-center justify-center text-[10px]" style={activeBg}>2</div>
                    <div className="w-5 h-5 rounded flex items-center justify-center text-[10px] font-bold" style={{ backgroundColor: theme.colors.text + '10' }}>3</div>
                </div>
            </GalleryItem>
            ...
            <GalleryItem title="Stepper: Number" centered>
                <div className="flex items-center">
                    ...
                    <div className="w-4 h-0.5" style={{ backgroundColor: theme.colors.text + '20' }}></div>
            ...
            <GalleryItem title="User Menu" centered>
                <div className="flex items-center gap-2 border rounded-full pl-1 pr-3 py-1 shadow-sm" style={{ backgroundColor: theme.colors.surface, borderColor: theme.colors.text + '20' }}>
            ...
            <GalleryItem title="Tree Item" centered>
                <div className="flex items-center gap-1 w-full px-4 text-[10px]">
                    ...
                    <Icons.Folder size="sm" className="w-3" style={{ color: theme.colors.warning }}/>
                    <span>src</span>
                </div>
            </GalleryItem>
            ...
            <GalleryItem title="Mobile Tab Bar" centered>
                <div className="flex justify-around w-full border-t pt-2" style={borderColor}>
                    <div className="w-4 h-4 rounded" style={{ backgroundColor: theme.colors.text + '20' }}></div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-16">
            ...
            <GalleryItem title="Slider Row" centered>
                <div className="w-full px-4">
                    ...
                    <div className="w-full h-1 rounded-full relative" style={{ backgroundColor: theme.colors.text + '10' }}>
            ...
            <GalleryItem title="Range Dual" centered>
                <div className="w-full px-4 relative h-4 flex items-center">
                    <div className="w-full h-1 rounded-full" style={{ backgroundColor: theme.colors.text + '10' }}></div>
            ...
            <GalleryItem title="Input Group" centered>
                <div className="w-full px-4">
                    ...
                    <div className="border rounded px-2 py-1 text-[10px] opacity-60" style={{ backgroundColor: theme.colors.text + '05', borderColor: theme.colors.text + '20' }}>user@example.com</div>
                </div>
            </GalleryItem>
            ...
            <GalleryItem title="Search Input" centered>
                <div className="w-full px-4 relative">
                    ...
                    <div className="border rounded-full pl-7 pr-2 py-1 text-[10px] opacity-60" style={{ borderColor: theme.colors.text + '30' }}>Search...</div>
                </div>
            </GalleryItem>

            <GalleryItem title="Password Input" centered>
                <div className="w-full px-4 relative">
                    <div className="border rounded px-2 py-1 text-[10px] flex justify-between items-center" style={{ borderColor: theme.colors.text + '30' }}>
            ...
            <GalleryItem title="Dropdown" centered>
                <div className="w-full px-4">
                    <div className="border rounded px-2 py-1 text-[10px] flex justify-between items-center shadow-sm" style={{ backgroundColor: theme.colors.surface, borderColor: theme.colors.text + '20' }}>
                        <span>Select...</span>
                        <Icons.ChevronDown size="sm" className="w-3 opacity-50"/>
                    </div>
                </div>
            ...
            <GalleryItem title="Date Input" centered>
                <div className="w-full px-4">
                    <div className="border rounded px-2 py-1 text-[10px] flex gap-2 items-center shadow-sm" style={{ backgroundColor: theme.colors.surface, borderColor: theme.colors.text + '20' }}>
            ...
            <GalleryItem title="Checkbox Item" centered>
                <div className="flex items-center gap-2 w-full px-4">
                    <div className="w-4 h-4 rounded border flex items-center justify-center text-white" style={{ backgroundColor: theme.colors.primary, borderColor: theme.colors.primary }}>
            ...
            <GalleryItem title="Radio Item" centered>
                <div className="flex items-center gap-2 w-full px-4">
                    <div className="w-4 h-4 rounded-full border flex items-center justify-center" style={{ borderColor: theme.colors.primary }}>
                        <div className="w-2 h-2 rounded-full" style={{ backgroundColor: theme.colors.primary }}></div>
                    </div>
            ...
            <GalleryItem title="Segment Control" centered>
                <div className="flex p-0.5 rounded-lg border w-3/4" style={{ backgroundColor: theme.colors.text + '05', borderColor: theme.colors.text + '10' }}>
                    <div className="flex-1 text-[8px] text-center py-1 shadow-sm rounded" style={{ backgroundColor: theme.colors.surface }}>Map</div>
            ...
            <GalleryItem title="Number Stepper" centered>
                <div className="flex border rounded overflow-hidden" style={{ borderColor: theme.colors.text + '20' }}>
                    <div className="px-2 border-r text-[10px]" style={{ backgroundColor: theme.colors.text + '05', borderColor: theme.colors.text + '20' }}>-</div>
                    <div className="px-2 text-[10px] font-bold">1</div>
                    <div className="px-2 border-l text-[10px]" style={{ backgroundColor: theme.colors.text + '05', borderColor: theme.colors.text + '20' }}>+</div>
                </div>
            </GalleryItem>

            <GalleryItem title="Text Area" centered>
                <div className="w-full px-4">
                    <div className="border rounded px-2 py-1 h-8 text-[8px] opacity-60 resize-none" style={{ backgroundColor: theme.colors.text + '05', borderColor: theme.colors.text + '20' }}>Type here...</div>
                </div>
            </GalleryItem>

            <GalleryItem title="File Upload" centered>
                <div className="w-3/4 border border-dashed rounded px-2 py-3 flex flex-col items-center gap-1" style={{ backgroundColor: theme.colors.text + '05', borderColor: theme.colors.text + '20' }}>
            ...
            <GalleryItem title="Chip: Filter" centered>
                <div className="flex items-center gap-1 px-2 py-0.5 rounded-full border text-[8px]" style={{ backgroundColor: theme.colors.text + '05', borderColor: theme.colors.text + '20' }}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-16">
            <GalleryItem title="Toast Success" centered>
                <div className="flex items-center gap-2 border px-3 py-2 rounded shadow-sm w-full mx-2" style={{ backgroundColor: theme.colors.success + '10', borderColor: theme.colors.success + '30' }}>
            ...
            <GalleryItem title="Toast Error" centered>
                <div className="flex items-center gap-2 border px-3 py-2 rounded shadow-sm w-full mx-2" style={{ backgroundColor: theme.colors.error + '10', borderColor: theme.colors.error + '30' }}>
            ...
            <GalleryItem title="Alert Info" centered>
                <div className="flex items-center gap-2 border px-2 py-1.5 rounded w-full mx-2" style={{ backgroundColor: theme.colors.info + '10', borderColor: theme.colors.info + '30' }}>
                    <span className="text-[10px]" style={{ color: theme.colors.info }}>Update available.</span>
                </div>
            </GalleryItem>

            <GalleryItem title="Alert Warning" centered>
                <div className="flex items-center gap-2 border px-2 py-1.5 rounded w-full mx-2" style={{ backgroundColor: theme.colors.warning + '10', borderColor: theme.colors.warning + '30' }}>
                    <Icons.Help size="sm" className="w-3" style={{ color: theme.colors.warning }}/>
                    <span className="text-[10px]" style={{ color: theme.colors.warning }}>Check connection.</span>
                </div>
            </GalleryItem>
            ...
            <GalleryItem title="Loading Dots" centered>
                <div className="flex gap-1">
                    <div className="w-1.5 h-1.5 rounded-full animate-bounce" style={{ backgroundColor: theme.colors.textSecondary }}></div>
                    <div className="w-1.5 h-1.5 rounded-full animate-bounce delay-75" style={{ backgroundColor: theme.colors.textSecondary }}></div>
                    <div className="w-1.5 h-1.5 rounded-full animate-bounce delay-150" style={{ backgroundColor: theme.colors.textSecondary }}></div>
                </div>
            </GalleryItem>

            <GalleryItem title="Progress Bar" centered>
                <div className="w-3/4 h-1.5 rounded-full overflow-hidden" style={{ backgroundColor: theme.colors.text + '10' }}>
            ...
            <GalleryItem title="Skeleton Row" centered>
                <div className="w-full px-4 space-y-2">
                    <div className="flex items-center gap-2">
                        ...
                        <div className="h-2 w-20 rounded" style={{ backgroundColor: theme.colors.text + '10' }}></div>
                    </div>
                </div>
            </GalleryItem>
            ...
            <GalleryItem title="Badge Count" centered>
                <div className="relative">
                    <Icons.Bell size="md"/>
                    <div className="absolute -top-1 -right-1 w-3 h-3 rounded-full text-[8px] text-white flex items-center justify-center font-bold" style={{ backgroundColor: theme.colors.error }}>3</div>
                </div>
            </GalleryItem>

            <GalleryItem title="Badge New" centered>
                <span className="px-2 py-0.5 rounded-full text-[8px] font-bold uppercase" style={{ backgroundColor: theme.colors.info + '20', color: theme.colors.info }}>New</span>
            </GalleryItem>

            <GalleryItem title="Status Online" centered>
                <div className="flex items-center gap-1.5 text-[10px]">
                    <div className="w-2 h-2 rounded-full" style={{ backgroundColor: theme.colors.success }}></div> Online
                </div>
            </GalleryItem>

            <GalleryItem title="Tooltip Box" centered>
                <div className="relative flex flex-col items-center">
                    <div className="text-white text-[8px] px-2 py-1 rounded mb-1" style={{ backgroundColor: theme.colors.text }}>Help</div>
                    <div className="w-0 h-0 border-l-4 border-r-4 border-t-4 border-l-transparent border-r-transparent" style={{ borderTopColor: theme.colors.text }}></div>
                </div>
            </GalleryItem>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-16">
            <GalleryItem title="List Item" centered>
                <div className="flex items-center justify-between w-full px-4 py-2 border-b" style={{ borderColor: theme.colors.text + '10' }}>
            ...
            <GalleryItem title="List Checkbox" centered>
                <div className="flex items-center gap-2 w-full px-4">
                    <div className="w-3 h-3 border rounded" style={{ borderColor: theme.colors.text + '40' }}></div>
            ...
            <GalleryItem title="List Action" centered>
                <div className="flex items-center justify-between w-full px-4">
                    ...
                    <div className="px-2 py-0.5 border rounded text-[8px]" style={{ borderColor: theme.colors.text + '20' }}>Edit</div>
                </div>
            </GalleryItem>
            ...
            <GalleryItem title="Chat Bubble" centered>
                <div className="text-white px-3 py-1.5 rounded-2xl rounded-tr-sm text-[10px]" style={{ backgroundColor: theme.colors.primary }}>
                    Hello there!
                </div>
            </GalleryItem>
            ...
            <GalleryItem title="Notification" centered>
                <div className="flex gap-2 w-full px-3">
                    <div className="w-2 h-2 rounded-full mt-1" style={{ backgroundColor: theme.colors.primary }}></div>
                    <div className="flex-1">
            ...
            <GalleryItem title="Comment" centered>
                <div className="flex gap-2 w-full px-3">
                    <div className="w-4 h-4 rounded-full" style={{ backgroundColor: theme.colors.text + '20' }}></div>
            ...
            <GalleryItem title="Timeline Item" centered>
                <div className="flex gap-2 w-full px-4 items-center">
                    <div className="w-2 h-2 rounded-full border-2" style={{ borderColor: theme.colors.primary }}></div>
                    <div className="h-px w-4" style={{ backgroundColor: theme.colors.text + '20' }}></div>
                    <div className="text-[10px]">Step 1</div>
                </div>
            </GalleryItem>

            <GalleryItem title="Grid Card" centered>
                <div className="border rounded p-2 text-center shadow-sm w-20" style={{ borderColor: theme.colors.text + '20' }}>
                    <div className="w-full h-8 mb-1 rounded-sm" style={{ backgroundColor: theme.colors.text + '10' }}></div>
                    <div className="text-[8px] font-bold">Image.png</div>
                </div>
            </GalleryItem>

            <GalleryItem title="Card: Media Top" centered>
                <div className="border rounded overflow-hidden w-24 shadow-sm" style={{ borderColor: theme.colors.text + '20' }}>
                    <div className="h-10" style={{ backgroundColor: theme.colors.text + '10' }}></div>
                    <div className="p-2">
                        <div className="h-2 w-12 rounded mb-1" style={{ backgroundColor: theme.colors.text + '20' }}></div>
            ...
            <GalleryItem title="Card: Pricing" centered>
                <div className="border rounded p-2 w-24 text-center shadow-sm" style={{ borderColor: theme.colors.text + '20' }}>
                    <div className="text-[8px] uppercase opacity-50">Basic</div>
                    <div className="text-lg font-bold leading-none my-1">$9</div>
                    <div className="h-4 text-white text-[8px] rounded flex items-center justify-center" style={{ backgroundColor: theme.colors.primary }}>Buy</div>
                </div>
            </GalleryItem>
        </div>
